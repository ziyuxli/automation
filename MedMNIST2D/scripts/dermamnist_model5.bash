...
COMMANDS=(
"python train_and_eval_pytorch.py --data_flag dermamnist --gpu_ids 0 --output_root /ocean/projects/cis250072p/wanyuef/asu/output --num_epochs 100 --as_rgb --size 224 --resize --batch_size 128 --model_flag resnet50 --download --run model5"
)
