...
COMMANDS=(
"python train_and_eval_pytorch.py --data_flag adrenalmnist3d --download --gpu_ids 0 --conv Conv3d --output_root /ocean/projects/cis250072p/wanyuef/asu/output --num_epochs 100 --as_rgb --shape_transform --batch_size 32 --model_flag resnet50 --run model6"
)
